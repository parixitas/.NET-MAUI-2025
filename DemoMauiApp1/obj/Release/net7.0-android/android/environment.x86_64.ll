...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"90a126ec-23a8-4e0b-a494-bec8713725c7\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [29 x i8] c"com.companyname.demomauiapp1\00", align 16
...
@__DSOCacheEntry_name.59 = internal constant [27 x i8] c"libaot-DemoMauiApp1.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 107
	%struct.DSOCacheEntry {
		i64 4654900959735388217, ; hash 0x409987c299a71839, from name: libaot-DemoMauiApp1
		i8 0, ; ignore
	...
	; 126
	%struct.DSOCacheEntry {
		i64 5948336048854175985, ; hash 0x528cbc1eec9a90f1, from name: aot-DemoMauiApp1
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 182
	%struct.DSOCacheEntry {
		i64 8151388673350255170, ; hash 0x711f8ccf7d2f4242, from name: libaot-DemoMauiApp1.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 226
	%struct.DSOCacheEntry {
		i64 9566071583466851541, ; hash 0x84c1836c04800cd5, from name: aot-DemoMauiApp1.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 377
	%struct.DSOCacheEntry {
		i64 15373513389779175931, ; hash 0xd559b0f9c37fc9fb, from name: DemoMauiApp1
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 447
	%struct.DSOCacheEntry {
		i64 18210524118301385103, ; hash 0xfcb8c733bd09a18f, from name: DemoMauiApp1.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.59, i32 0, i32 0), ; name
		i8* null; handle
	}, 
